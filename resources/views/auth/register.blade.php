                                ...
                                <form class="text-left">
                                    <div class="form">
                                        ...
                                        <!-- <div id="email-field" class="field-wrapper input">
                                            ...
                                            <input id="avatar" name="avatar" type="file" value="" class="form-control @error('avatar') is-invalid @enderror" placeholder="avatar" required autocomplete="avatar">
                                            @error('avatar')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <!-- <div id="username-field" class="field-wrapper input">
                                            <div class="d-flex justify-content-between">
                                                <label for="telephone">{{ __('Telephone No') }}</label>
                                            </div>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user">
                                                <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
                                                <circle cx="12" cy="7" r="4"></circle>
                                            </svg>
                                            <input id="telephone" type="tel" class="form-control @error('telephone') is-invalid @enderror" name="telephone" value="{{ old('telephone') }}" placeholder="011 2286954" required autocomplete="telephone" autofocus>
                                            @error('telephone')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <!-- <div id="grade" class="field-wrapper input">
                                            <div class="d-flex justify-content-between">
                                                <label for="grade">{{ __('Grade') }}</label>
                                            </div>
                                            {{-- <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg> --}}
                                            {{-- <input id="grade" name="txtgrade" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" placeholder="Username" required autocomplete="name" autofocus> --}}

                                            <select class="form-control" id="grade" name="txtgrade">
                                        ...
                                        <!-- <div id="grade" class="field-wrapper input">
                                            ...
                                            <select class="form-control" id="package" name="txtpackage">
