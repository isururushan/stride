<template>
    <h1 style="padding-left: 350px;padding-top: 200px;">Administrator Dashboard View</h1>
    <!--  BEGIN CONTENT AREA  -->
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <div class="td-content customer-name">
                            <img src="assets/img/profile-7.jpg" alt="avatar" />Andy King
                          </div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div class="td-content customer-name">
                            <img src="assets/img/profile-4.jpg" alt="avatar" />Irene Collins
                          </div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div class="td-content customer-name">
                            <img src="assets/img/profile-10.jpg" alt="avatar" />Laurie Fox
                          </div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div class="td-content customer-name">
                            <img src="assets/img/profile-13.jpg" alt="avatar" />Luke Ivory
                          </div>
                        </td>
                        <td>
                          <div class="td-content product-brand">
                      ...
                      <tr>
                        <td>
                          <div class="td-content customer-name">
                            <img src="assets/img/profile-5.jpg" alt="avatar" />Ryan Collins
                          </div>
                        </td>
                        <td>
                      ...
                      <tr>
                        <td>
                          <div class="td-content customer-name">
                            <img src="assets/img/profile-6.jpg" alt="avatar" />Nia Hillyer
                          </div>
                        </td>
                        <td>
                          <div class="td-content product-brand">
                      ...
                      <tr>
                        <td>
                          <div class="td-content customer-name">
                            <img src="assets/img/profile-11.jpg" alt="avatar" />Sonia Shaw
                          </div>
                        </td>
                        <td>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <div class="td-content product-name">
                            <img src="assets/img/speaker.jpg" alt="product" />Speakers
                          </div>
                        </td>
                        <td>
                          <div class="td-content">
                      ...
                      <tr>
                        <td>
                          <div class="td-content product-name">
                            <img src="assets/img/sunglass.jpg" alt="product" />Sunglasses
                          </div>
                        </td>
                        <td>
                          <div class="td-content">
                      ...
                      <tr>
                        <td>
                          <div class="td-content product-name">
                            <img src="assets/img/watch.jpg" alt="product" />Watch
                          </div>
                        </td>
                        <td>
                          <div class="td-content">
                      ...
                      <tr>
                        <td>
                          <div class="td-content product-name">
                            <img src="assets/img/laptop.jpg" alt="product" />Laptop
                          </div>
                        </td>
                        <td>
                          <div class="td-content">
                      ...
                      <tr>
                        <td>
                          <div class="td-content product-name">
                            <img src="assets/img/camera.jpg" alt="product" />Camera
                          </div>
                        </td>
                        <td>
                          <div class="td-content">
                      ...
                      <tr>
                        <td>
                          <div class="td-content product-name">
                            <img src="assets/img/shoes.jpg" alt="product" />Shoes
                          </div>
                        </td>
                        <td>
                          <div class="td-content">
                      ...
                      <tr>
                        <td>
                          <div class="td-content product-name">
                            <img src="assets/img/headphones.jpg" alt="product" />Headphone
                          </div>
                        </td>
                        <td>
                          <div class="td-content">
