                                    ...
                                    <div class="widget-content widget-content-area">
                                        ...
                                        <form method="POST" enctype="multipart/form-data" @submit.prevent="createUser">
                                            <div style="margin: 50px">
                                                ...
                                                <!-- <div class="form-row mb-4">
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleFormControlInput1">Login Start Time</label>
                                                        <input type="time" class="form-control" v-model="start_time" />
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="exampleFormControlInput1">Login End Time</label>
                                                ...
                                                <!-- <div class="form-row mb-4">
                                                    <div class="form-group col-lg-12">
                                                        <label for="exampleFormControlInput1">Admin Type</label>
                                                         <select class="form-control" :class=" errors.admin_type ? 'form-control is-invalid' : 'form-control' " v-model="admin_type">
                                                            <option value="null">Select Admin Type</option>
                                                            <option value="super_admin">Super Admin</option>
                                                            <option value="admin">Admin</option>
                                                        </select>
                                                        <small v-if=" errors.admin_type " class="text-danger">{{errors.admin_type[0]}}</small>
                                                    </div>
                                                </div> -->
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr v-for="(admin, index) in admins" :key="index">
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                        <button class="btn btn-primary mb-2 mx-4" @click="
                                                                setToUpdate(admin.id, admin.name, admin.email, admin.active )" data-toggle="modal" data-target="#editAdminModal">
                                                ...
                                                <td class="text-center">
                                                    <button class="btn btn-danger mb-2" @click="destroyAdmin(admin.id)">
...
export default {
    ...
    methods: {
        ...
        setToUpdate(id, name, email, active) {
            this.edit_id = id;
            this.edit_name = name;
